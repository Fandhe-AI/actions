...
- 迂回できるのは write 権限を持つ主体だけで、その主体は ruleset 自体も変更できる。
  つまりこの skip が無くても同じ結果に到達でき、新たな権限昇格にはならない
